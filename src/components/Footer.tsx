            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  ...
                  >
                    <span className="w-1 h-1 bg-gold-400 rounded-full group-hover:bg-gold-400 transition-colors" />
                    {link.label}
                  </Link>
                </li>
              ))}
              ...
              <div className="flex flex-wrap gap-2">
                {socials.map((s) => (
                  <a
                    ...
                    title={s.name}
                    className="w-9 h-9 bg-navy-700 hover:bg-gold-400 rounded-lg flex items-center justify-center text-gray-400 hover:text-navy-900 transition-all duration-300 hover:-translate-y-1"
                  >
                    {s.icon}
                  </a>
                ))}
