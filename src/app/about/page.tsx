    ...
    <>
      ...
      <section className="bg-purple-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-teal-400 font-semibold text-sm tracking-widest uppercase mb-3">Who We Are</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              <p className="text-teal-500 font-semibold text-sm tracking-widest uppercase mb-3">Vision Statement</p>
            ...
            <div className="grid grid-cols-2 gap-5">
              {[
                ...
                <div key={s.l} className="bg-gray-50 rounded-xl p-6 text-center border border-gray-100 hover:shadow-md transition-shadow">
                  <p className="font-heading text-4xl font-bold text-purple-700 mb-2">{s.v}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-teal-500 font-semibold text-sm tracking-widest uppercase mb-3">Our Background</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-purple-800 rounded-xl p-7 text-white">
              <h3 className="font-heading text-xl font-semibold text-teal-400 mb-6">Working Experience With</h3>
              <div className="space-y-4">
                {experience.map((e) => (
                  <div key={e.firm} className="flex items-start gap-3 border-b border-purple-700 pb-4 last:border-0 last:pb-0">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-teal-500 font-semibold text-sm tracking-widest uppercase mb-3">Our Foundation</p>
            <h2 className="section-heading">Our Core Values</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div key={v.title} className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:border-teal-400 hover:shadow-md transition-all">
                <div className="w-10 h-10 bg-purple-800 rounded-lg flex items-center justify-center mb-4">
                  <div className="w-3 h-3 bg-teal-400 rounded-full" />
                </div>
                <h3 className="font-heading font-semibold text-purple-800 text-lg mb-2">{v.title}</h3>
