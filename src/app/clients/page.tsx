    ...
    <>
      ...
      <section className="bg-purple-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-teal-400 font-semibold text-sm tracking-widest uppercase mb-3">Trusted By Many</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-teal-500 font-semibold text-sm tracking-widest uppercase mb-3">Portfolio</p>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            {clients.map((client) => (
              <div
                key={client.name}
                className="group bg-gray-50 border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center hover:border-teal-400 hover:shadow-md transition-all duration-300"
              >
                {/* Logo placeholder with initial */}
                <div className="w-14 h-14 bg-purple-800 rounded-full flex items-center justify-center mb-4 group-hover:bg-teal-500 transition-colors">
                  <span className="text-white font-heading font-bold text-xl">
                    {client.name.charAt(0)}
                  </span>
                </div>
                <h3 className="font-heading font-semibold text-purple-800 text-sm mb-1">{client.name}</h3>
                <span className="text-teal-500 text-xs font-medium bg-teal-50 px-2 py-0.5 rounded-full">
                  {client.sector}
                </span>
              </div>
            ))}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-teal-500 font-semibold text-sm tracking-widest uppercase mb-3">Client Feedback</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              ...
              >
                {/* Quote mark */}
                <div className="absolute top-5 right-6 text-teal-200 text-6xl font-heading leading-none select-none">
                  &ldquo;
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-purple-800 text-sm">{t.author}</p>
