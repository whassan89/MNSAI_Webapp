  ...
  return (
    <>
            ...
            <AnimateOnView direction="left">
              ...
              <div className="space-y-6">
                {contactDetails.map((item) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-12 h-12 bg-navy-800 rounded-lg flex items-center justify-center text-gold-400 group-hover:bg-gold-400 group-hover:text-white transition-colors duration-200">
                      {item.icon}
                    </div>
                    <div>
              ...
              <div className="mt-10">
                ...
                <div className="flex gap-3">
                  <a href="https://facebook.com/mnsaiconsultants" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 bg-navy-800 hover:bg-gold-400 rounded-lg flex items-center justify-center text-white transition-colors">
      ...
      <section className="bg-gray-100 h-72 flex items-center justify-center">
        ...
        >
          <svg className="w-12 h-12 text-navy-700 mx-auto mb-3 group-hover:text-gold-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
